    ...
    <main className="store-page mx-auto w-full max-w-5xl px-4 py-5 sm:py-9">
      ...
      {items.length ? (
        <div className="grid gap-5 md:grid-cols-[1fr_300px]">
          ...
          <aside className="panel warm-summary h-fit p-5 md:sticky md:top-24"><p className="text-sm font-bold text-gray-600">Order total</p><strong className="price-text mt-1 block text-2xl sm:text-3xl">Rs. {total}</strong><Link className="btn-primary mt-4 w-full" to="/checkout">Checkout</Link></aside>
        </div>
      ) : (
