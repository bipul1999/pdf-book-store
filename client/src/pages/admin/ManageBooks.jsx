      ...
      {loading ? <p className="p-5">Loading...</p> : (
            ...
            <article className="rounded-2xl border border-slate-100 bg-white p-3 shadow-sm" key={book._id}>
              <div className="grid grid-cols-[72px_1fr] gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="price-text mt-1">Rs. {book.price}</p>
        ...
        <div className="hidden overflow-x-auto sm:block">
          <table className="w-full text-left text-sm">
            <thead className="bg-gray-50 text-gray-600"><tr><th className="p-3">Book</th><th className="p-3">Price</th><th className="p-3">Action</th></tr></thead>
            <tbody>
              {books.map((book) => (
