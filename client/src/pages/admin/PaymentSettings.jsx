...
export default function PaymentSettings() {
  const [form, setForm] = useState({ upiId: "", payeeName: "", manualPaymentExtraCharge: "10", razorpayPaymentExtraCharge: "20", orderBookExtraCharge: "0", instructions: "" });
  ...
  useEffect(() => {
    api.get("/admin/payment-settings").then(({ data }) => {
      setForm({
        ...
        manualPaymentExtraCharge: data.settings.manualPaymentExtraCharge ?? 10,
        razorpayPaymentExtraCharge: data.settings.razorpayPaymentExtraCharge ?? 20,
